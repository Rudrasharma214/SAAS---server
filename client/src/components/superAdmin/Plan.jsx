...
import { Plus, X, Edit, Trash2, Users, UserCheck, Calendar, DollarSign, Sparkles } from 'lucide-react';
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button className={`flex-1 px-4 py-2.5 rounded-lg font-medium transition-all ${
                    isDarkMode

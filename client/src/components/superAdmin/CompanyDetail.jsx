...
const CompanyDetail = ({ companyId, onBack }) => {
  ...
  if (!company) {
    return (
      <div className="flex justify-center items-center h-64 text-zinc-400">No company found.</div>
    );
  }

  return (
    <div className="p-4 text-zinc-200">
      <div className={`max-w-md mx-auto ${isDarkMode ? 'bg-gradient-to-r to-stone-800 from-slate-700' : 'bg-gradient-to-r to-indigo-400 from-blue-400'} rounded-2xl p-6 shadow-lg border border-zinc-800/50`}>

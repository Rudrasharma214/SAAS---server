          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
              ...
              <p className={isDarkMode ? 'text-zinc-400' : 'text-gray-600'}>
                View, create, and manage employee accounts.
              </p>
            </div>
            <button
                ...
                <table className="w-full">
                  ...
                  >
                    {users.map((user) => (
                      <tr
                        key={user._id}
                        className={`transition-colors ${isDarkMode ? 'hover:bg-zinc-800' : 'hover:bg-gray-50'}`}
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {user.managerId ? (
                            ...
                            <span
                              className={`text-xs italic ${isDarkMode ? 'text-zinc-500' : 'text-gray-500'}`}
                            >
                              No Manager
                            </span>
                          )}
